...
local attach = function(client, bufnr, alt_keys)
    ...
    vim.keymap.set("n", "]D",         alt_keys and alt_keys.diagnostic_goto_next  or old_goto_prev,                   Dops)
    vim.keymap.set("n", "[d",         alt_keys and alt_keys.diagnostic_goto_prev  or old_goto_prev,                   Dops)
    vim.keymap.set("n", "[D",         alt_keys and alt_keys.diagnostic_goto_prev  or old_goto_next,                   dops)
