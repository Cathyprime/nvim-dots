...
later(function()
    ...
    vim.keymap.set("n", "<c-f>", "<cmd>Grapple select index=1<cr>")
    vim.keymap.set("n", "<c-s>", "<cmd>Grapple select index=2<cr>")
    vim.keymap.set("n", "<c-n>", "<cmd>Grapple select index=3<cr>")
    vim.keymap.set("n", "<c-h>", "<cmd>Grapple select index=4<cr>")
end)
